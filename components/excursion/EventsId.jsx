  ...
  useEffect(() => {
    const fetchTrips = async () => {
      try {
        ...
        // Filter out the current trip and pick 4 other trips
        const filteredTrips = fetchedTrips.filter((trip) => trip.id !== id);
        setOtherTrips(filteredTrips.slice(0, 4)); // Select the first 4 trips
