...
const SinglePageProduct = ({ slug }) => {
  ...
  const [quantity, setQuantity] = useState({ single: 0, double: 0 });
  ...
  const tripAvis = (tripId) => {
    axios
      .get(
        `/api/items/avis?filter={%20"trip_id":%20{%20"_eq":%20${tripId}%20}}`
      )
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 rounded-lg bg-white ">
        <div className="flex flex-col justify-center items-center  lg:flex-row gap-6 lg:gap-10">
          {/* Left: Image Gallery */}
          <div className="lg:w-1/2 space-y-4">
            {/* Main Image */}
            <div className="flex justify-center items-center">
              <div className="w-full h-[400px] md:w-3/4 lg:w-[800px] lg:h-[450px] overflow-hidden rounded-lg shadow-lg">
                <Image
          ...
          <div className="lg:w-1/2 space-y-3 ">
            ...
            <div className="mt-4 flex items-center">
              ...
              <span className="text-sm  pl-2 text-blue-500 ">
                <a href="#avis">voir..</a>
              </span>
            </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <div className="w-full">
                      ...
                      <input
                        ...
                        className="border-2 rounded-lg border-gray-300 p-2 w-full text-sm sm:text-base"
                      />
                    </div>
                    <div className="w-full">
                      <label className="block mb-1 text-xs ">
                        Double Quad Quantity
                      </label>
                      <input
                        type="number"
                        min="0"
